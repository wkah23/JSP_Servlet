...
<body>
<!-- 
	set태그 : 변수를 선언할 때 사용. JSP의 setAttribute()와 동일한 기능을 한다.
 ...
 -->
	...
	<!-- 위 4개의 변수는 scope 지정이 없으므로 가장좋은 page영역에 저장된다. -->
	...
	<!-- 자바빈즈의 정의한 setter()를 통해 초기화한다. 값을 나중에 설정하려면
	target과 property 속성을 사용한다. target에는 변수를 property에는 멤버변수
	명을 지정한다. -->
