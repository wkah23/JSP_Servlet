...
public class BoardPage {
	 ...
	 */
	public static String pagingStr(int totalCount, 
		int pageSize, int blockPage, int pageNum, String reqUrl) {
		...
		/*
		  	pageTemp가 1이 아닐때만, 즉 첫번째 블럭이 아닐때만 이전블럭 바로가기
		  	링크를 화면에 출력한다.
		 */
		if (pageTemp != 1) {
		...
		/*
		  	...
		  	이때 1씩 증가 시켜준다. 즉 한블럭당 5페이지를 출력한다.
		 */
		int blockCount = 1;
